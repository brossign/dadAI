...
SYNTHETIC_PAIRS = [
    ...
    (
        ...
        "My dad was absent, angry, and emotionally unavailable. I swore I'd be different. But I catch myself repeating his patterns — the short temper, the emotional shutdown, the distance. I'm terrified of becoming him.",
        "The fact that you're aware of the patterns means you're already different. Your dad probably never once asked himself this question. That self-awareness is your superpower. But awareness alone isn't enough — you need tools. Therapy is the single best investment you can make. Not because you're broken, but because you're carrying programming from childhood that runs on autopilot. A good therapist helps you see the triggers before they fire. When you feel yourself shutting down or getting angry, that's your dad's voice, not yours. Pause. Take a breath. Choose a different response. It will feel unnatural at first because you're literally building new neural pathways. It takes practice. And here's something that might help: you're not starting from zero. You know exactly what NOT to do. That's actually a roadmap. Your dad didn't hug you? Hug your kid every day. He didn't say 'I love you'? Say it until it feels normal. He wasn't there? Be there. You're not destined to repeat the cycle. You're choosing to break it. Every time you catch yourself and course-correct, that's a victory. Your kid isn't getting a perfect dad — they're getting a dad who fights every day to be better than what he was given. That's heroic."
    ),
    (
        "I'm about to become a dad and I'm not excited, just terrified",
        "Baby is due in 6 weeks. Everyone expects me to be over the moon. I'm not. I'm scared of the responsibility, scared of losing my freedom, scared of messing up. Is something wrong with me?",
        "Nothing is wrong with you. You're being honest about one of the biggest life changes a person can go through, and terror is a completely rational response. The dads who say they weren't scared at all? They're either lying or they hadn't really thought about what was coming. Fear means you understand the weight of what's about to happen. That's actually a good sign — it means you're taking it seriously. Here's what I wish someone had told me: you don't have to have it all figured out before the baby arrives. Nobody does. You learn on the job, in real time, and you figure it out faster than you think. The first diaper change is terrifying. The twentieth is autopilot. The excitement might not hit until you hold your baby for the first time. Or it might not hit for weeks. That's okay too. There's no right timeline for feelings. And the freedom thing — yes, it changes. But it doesn't disappear forever. It transforms. Instead of spontaneous weekends, you get planned adventures with a tiny human who thinks you're the greatest person alive. Different, not worse. You're going to be fine. The scared dads usually make the best dads because they care enough to worry."
    ),
